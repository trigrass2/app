<template>
	<view>
		<ly-tree-drawer class="tree" :show="showTree" :treeData="treeList" @close="close" @confirm="confirm">
		</ly-tree-drawer>
		<!-- 列表 -->
		<view class="list">
...
<style lang="scss" scoped>
	...
	.tree {
		/deep/.ly-tree--highlight-current .ly-tree-node.is-current>.ly-tree-node__content {
			.ly-iconfont {
				color: $white-color;
			}
			color: $white-color;
